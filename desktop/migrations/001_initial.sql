...
-- ============================================================
-- P2P Invite Tokens (mirrored in 002_invite_tokens.sql — keep in step)
-- ============================================================
...
-- ============================================================
-- Support diagnostics (mirror of 004_support_diagnostics.sql)
-- ============================================================
-- diag_* = the node's own incident log + the per-warrant state machine
-- that makes a support warrant single-use; support_* = what user nodes
-- send the master (reports, issued warrants, boxed bundles). Same
-- schema on every node; only the master writes support_* rows.
