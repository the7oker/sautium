...
def generate_env_file(config: dict, env_path: Path) -> None:
    ...
    lines = [
        ...
        "",
        "# AI Providers — the wizard's pick and keys. The backend copies them",
        "# into user_settings at its FIRST boot only; the Web UI's choice",
        "# rules afterwards, whatever this file says.",
