...
Структурні категорії (albums/tracks/album_tracks/artist_mbids) під v4
СПЛЯТЬ: скелет носія вже має структуру, обкладинки й канон-мітки
артистів з MB-мінту, і вони канонічніші за пушерські; імпортери
лишаються як страховка full-режиму. Аудіо-аналіз лягає в готове гніздо —
