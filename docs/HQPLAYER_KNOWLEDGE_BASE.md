...
> **Примітка (HQP6):** цей каталог укладено з мануалу HQPlayer 5 Desktop (v5.16.0).
> Починаючи з HQP6, Sautium читає списки фільтрів / шейперів / режимів **та** описи
> кожного фільтра наживо з HQPlayer під час виконання, тому цей файл тепер є
> **вторинним довідником для людини**, а не джерелом, на яке покладається AI DJ.
> Доступність фільтрів / модуляторів та їхні описи слід брати з живого екземпляра
> HQPlayer.
